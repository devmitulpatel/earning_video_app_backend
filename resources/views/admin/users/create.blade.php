...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.users.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="nick">{{ trans('cruds.user.fields.nick') }}</label>
                <input class="form-control {{ $errors->has('nick') ? 'is-invalid' : '' }}" type="text" name="nick" id="nick" value="{{ old('nick', '') }}">
                @if($errors->has('nick'))
                    <span class="text-danger">{{ $errors->first('nick') }}</span>
                @endif
                <span class="help-block">{{ trans('cruds.user.fields.nick_helper') }}</span>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label for="social_connect">{{ trans('cruds.user.fields.social_connect') }}</label>
                <textarea class="form-control {{ $errors->has('social_connect') ? 'is-invalid' : '' }}" name="social_connect" id="social_connect">{{ old('social_connect') }}</textarea>
                @if($errors->has('social_connect'))
                    <span class="text-danger">{{ $errors->first('social_connect') }}</span>
                @endif
                <span class="help-block">{{ trans('cruds.user.fields.social_connect_helper') }}</span>
            </div>
            <div class="form-group">
